...
function SecondCard() {
  return (
    <div className="p-14 w-[791px] h-[144px] m-[150px]  absolute right-[20px] grid grid-cols-1 border-solid border-radi bg-gray-100 rounded-xl  shadow-gray-100 md:shadow-gray-500 lg:shadow-gray-900">
      <div>
        <div className="rounded-xl absolute top-4 left-[20px] bg-blue-300 w-[115px]  shrink-0 flex flex-row p-2  font-primary box-border items-center justify-center gap-[10px]">
          <img
